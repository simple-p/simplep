...
@user = User.create! name: "AA", email: "a@example.com", password: "123456", created_at: 7.days.ago 
@user.default_avatar

@user2 = User.create! name: "BB", email: "b@example.com", password: "123456", created_at: 7.days.ago
@user2.default_avatar

n = 30
@team1 = Team.create! name: "TeamAA", created_at: n.days.ago
@team2 = Team.create! name: "TeamBB", created_at: n.days.ago

@team1.memberships.create! member: @user, created_at: n.days.ago
@team1.memberships.create! member: @user2,  created_at: n.days.ago

n2 = rand(1..n)
@project = @team1.projects.create! name: "ProjectA", created_at:  n2.days.ago
n22 = rand(1..n)
@project2 = @team1.projects.create! name: "ProjectB", created_at:  n22.days.ago
10.times do
  n3 = rand(1..n2)
  n4 = rand(1..n3)
